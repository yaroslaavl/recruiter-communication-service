...
public class RabbitConfig {
    ...
    public RabbitConfig(
            @Value("${rabbitmq.communication.exchange}") String userExchange,
            @Value("${rabbitmq.communication.queues.start.name}") String userQueue,
            @Value("${rabbitmq.communication.queues.start.routing-key}") String userRoutingKey,
            @Value("${rabbitmq.communication.queues.start.arguments.x-dead-letter-exchange}") String userDlxExchange,
            @Value("${rabbitmq.communication.queues.start.arguments.x-dead-letter-routing-key}") String userDlqRoutingKey,
            @Value("${rabbitmq.communication.queues.start.arguments.x-message-ttl}") long ttl,
            @Value("${rabbitmq.communication.queues.start.arguments.x-max-length}") long length,
            @Value("${rabbitmq.communication.queues.dead-letter.queue.name}") String userDlq
    ) {
